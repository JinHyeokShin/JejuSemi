    ...
    <aside>
        <div id="sidebar" class="nav-collapse ">
          ...
          <ul class="sidebar-menu" id="nav-accordion">
            ...
            <li class="sub-menu">
              <a class = "active2" href="javascript:;">
                <i class="fa fa-desktop"></i>
                <span>숙소 관리</span>
                </a>
              <ul class="sub">
                <li><a href="#" class="active3">숙소 후기 관리</a></li>
                <li><a href="calendar.html" class="active4">숙소 예약 관리</a></li>
                <li><a href="morris.html" class="active5">고객 이용 통계 조회</a></li>
                <!-- <li><a href="font_awesome.html">Font Awesome</a></li> -->
              </ul>
            </li>
            <li>
                <a href="pricing_table.html" class="active6">
            ...
            <li>
                <a href="contactform.html" class="active8">
                  <i class="fa fa-envelope"></i>
                  <span>문의하기</span>
                  <span class="label label-theme pull-right mail-info">2</span>
                  </a>
