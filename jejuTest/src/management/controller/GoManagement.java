 ...
 */
@WebServlet("/management.ow")
public class GoManagement extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{ 
		...
		request.getRequestDispatcher("views/adminowner/owner/management.jsp").forward(request, response);
